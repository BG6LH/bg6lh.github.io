...
![FT-817 DATA接口定义](./diy-ft-817-data-cable.png)


**MD6接口的定义：**
| 图片 | 说明 |
| --- | --- |
| ![插座正面](./diy-ft-817-data-cable-1.png) | 插座正面图 |
| ![插座镜像](./diy-ft-817-data-cable-2.png) | 连线的时候要注意，对应的是插座正面的镜像标准画法反面图的针脚应该是黑色的圆点，表示是针 |
