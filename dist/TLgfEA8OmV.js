...
if (location.hostname !== 'localhost' && !location.hostname.startsWith('192.168.') ) {
    (function (u, m, a, n, i) {
      window.umami = window.umami || function () { (umami.q = umami.q || []).push(arguments) }
      umami('create', i, { autoTrack: true })
      var d = document, s = d.createElement('script')
      s.src = u + '/umami.js'
      s.async = true
      d.head.appendChild(s)
    })('https://bg6lh.github.io', document, window, 0, 'e7795679-6456-4a17-819f-508502dac125')
  }