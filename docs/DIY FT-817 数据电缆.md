...
author:
  - BG6LH
createTime: 2018-07-09 08:00:00
date: 2018-07-10
description: 为了在FT-817上更方便地玩FT8，我做了一根DATA电脑连接线。配合以前买的一根写频线控制FT-817的PTT，整个系统工作的很顺溜。连接线的制作方法很简单，主要材料是一根标准MD6的线，两个立体声插头，一个USB声卡，直接连到一起就搞定。
imageNameKey: diy-ft-817-data-cable
permalink: /blog/diy-ft-817-data-cable/
publish: truex
tags:
  - FT-817
  - FT8
...
这个DATA接口，它的名字叫“数据”，其实是通过**音频电平**(音量)来跟其它设备进行信号传递的。这是一个彻头彻脑的“音频”设备。
...
![FT-817 DATA接口定义](/images/diy-ft-817-data-cable.png)


**MD6接口的定义：**

| ![插座正面](/images/diy-ft-817-data-cable-1.png) | 插座正面图                                       |
| ------------------------------------------- | ------------------------------------------- |
| ![插座镜像](/images/diy-ft-817-data-cable-2.png) | 连线的时候要注意，对应的是插座正面的镜像标准画法反面图的针脚应该是黑色的圆点，表示是针 |
|                                             |                                             |
